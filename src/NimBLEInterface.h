...
public:
    ...
    NimBLEInterface(NimBLEServer& server, Manager& manager, const String& deviceName = "ESP32");
    ~NimBLEInterface();
...
#else
#error "NimBLEInterface requires the NimBLE-Arduino library"
#endif
